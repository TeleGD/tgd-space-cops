...
// Ce tir fait une couronne autour du tireur, qui s'elargit au fil du temps.
	...
	public ProjectileType3(World world,double x, double y, double angle, double speed, int shotCount, boolean allied) {
		super(world, x, y, angle, speed, allied);
		shot = new ArrayList<Projectile>();
		this.shotCount = shotCount;

		for(int i = 1;i<shotCount;i++){
			shot.add(new Projectile(world, x, y, angle + i*360/(shotCount-1), speed, allied));
		}
	}
