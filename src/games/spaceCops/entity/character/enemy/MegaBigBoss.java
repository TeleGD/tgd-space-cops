...
public class MegaBigBoss extends Boss{
	...
	private Tourret tour1,tour2,tour3,tour4,tour5,tour6,tour7,tour8,tour9,tour10,tour11,tour12,tour13,tour14,tour15,tour16;

	public MegaBigBoss(World world, double x, double y, double width, double height, int time) {
		super(world, x, y, width, height, time);
		speedY = 0.05;
		skin = AppLoader.loadPicture("/images/spaceCops/bIGbOSS.png");
