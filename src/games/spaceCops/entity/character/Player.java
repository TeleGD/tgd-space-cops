package games.spaceCops.entity.character;
...
import games.spaceCops.bonus.Bonus;
...
import games.spaceCops.util.Collisions;
...
public class Player extends Movable implements Rectangle {
	...
	public Player(World world, ScoresMenu scoresMenu) {
		...
		imagedroite=AppLoader.loadPicture("/images/spaceCops/ship2.png");
		imagegauche=AppLoader.loadPicture("/images/spaceCops/ship0.png");
		imagecentrale=AppLoader.loadPicture("/images/spaceCops/ship1.png");
		image=imagecentrale;
	}
